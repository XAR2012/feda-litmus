...
/***/ function(module, exports) {
	...
	// https://mobiledx-mkt-prod3.campaign.adobe.com/xtk/acriteIndex.jssp

	function extractAdobeSubjectLine() {
	  setInterval(function () {
	    var subjectLine = document.querySelector('div[placeholder="Subject name"]').textContent;

	    window.top.postMessage({
	      method: 'checklist-adobeCampaignEmailDesignerSendSubjectLine',
	      content: subjectLine }, '*');
	  }, 5000);
	}

	if (undefined) {
	  module.exports = { extractAdobeSubjectLine: extractAdobeSubjectLine };
	} else {
	  extractAdobeSubjectLine();
	}

/***/ }
/******/ ]);
//# sourceMappingURL=adobe_campaign_email_designer_subject_line.js.map