...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseProvidersAdminMailchimpCom = __webpack_require__(3);

	var _baseProvidersAdminMailchimpCom2 = babelHelpers.interopRequireDefault(_baseProvidersAdminMailchimpCom);

	var _helpersAccountHelpers = __webpack_require__(5);

	var _helpersAccountHelpers2 = babelHelpers.interopRequireDefault(_helpersAccountHelpers);

	const provider = new _baseProvidersAdminMailchimpCom2['default']();

	provider.getAccountInfo(_helpersAccountHelpers2['default']);
...
/***/ function(module, exports) {
	...
	exports.__esModule = true;
	exports['default'] = storeCurrentEspAccount;

	function storeCurrentEspAccount(accountInfo) {
	  // console.log('Sending message to store account : ', accountInfo);
	  chrome.runtime.sendMessage({
	    type: 'set_esp_account',
	    data: accountInfo
	  }, function () {
	    // console.log('esp_accounts set!!!');
	  });
	}
...
/***/ }
/******/ ]);
//# sourceMappingURL=mailchimpInject.js.map