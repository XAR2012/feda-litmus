...
/***/ function(module, exports, __webpack_require__) {
	...
	setTimeout(function () {
	  ...
	  frame.contents().find('body').on('change, keydown', function () {
	    window.top.postMessage({ method: 'checklist-showRetestButton' }, '*');
	  });

	  jQuery(document).on('change, keydown', '#xEditingArea textarea', function () {
	    window.top.postMessage({ method: 'checklist-showRetestButton' }, '*');
	  });
	}, 1000);
...
/***/ }
/******/ ]);
//# sourceMappingURL=silverpop-iframeMessages.js.map