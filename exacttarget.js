...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modulesUtils = __webpack_require__(4);

	var _modulesUtils2 = babelHelpers.interopRequireDefault(_modulesUtils);
	...
	function getId() {
	  ...
	  // pass email id to sidebar immediately for logging purposes
	  _modulesUtils2['default'].postMessageToIframeWindow({
	    method: 'checklist-saveEmailId',
	    id: id
	  }, '*');
	    ...
	    if (mutation.addedNodes && mutation.addedNodes.length > 0) {
	      ...
	      if (frame) {
	        (function () {
	          ...
	          if (_jquery2['default']('textarea[name="HTMLBodyText"]').length > 0) {
	            // classic content
	            contents = _jquery2['default']('textarea[name="HTMLBodyText"]').val();
	          } else {
	            contents = _jquery2['default']('iframe').contents().find('html').html();
	          }

	          if (contents && (_jquery2['default'].trim(_jquery2['default'](contents).text()) || _jquery2['default'](contents).find('img').length)) {
	            debounce('getTestResults', 1000, function () {
	              id = getId();
...
/***/ }
/******/ ]);
//# sourceMappingURL=exacttarget.js.map