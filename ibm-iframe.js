...
/***/ function(module, exports, __webpack_require__) {
	...
	const ChecklistTester = __webpack_require__(4);

	window.top.postMessage({ method: 'checklist-ibmClearContent' }, '*');
	var idMatch = window.location.href.match(/mailingid=(\d+)/) || window.location.href.match(/.\/composer\/(\d+)(\/.)*/);
	var currentHtml = null;

	var timer = setInterval(function () {
	  html = _jquery2['default']('#previewFrame').contents().find('html').html();
	  if (html && html !== currentHtml) {
	    replaceImages(html).then(function (imageData) {
	      if (idMatch) {
	        ChecklistTester.replaceImagesWithS3Paths(html, imageData).then(function (content) {
	          window.top.postMessage({ method: 'checklist-ibmSendContent', id: idMatch[1], content: content }, '*');
	          currentHtml = html;
	        });
	      }
	    });
	...
	function replaceImages(html) {
	  var imagePaths = html.match(/<img [^>]*src="([^"]*)"/);
	  ...
	  imagePaths.shift();
	  // remove all http paths
	  imagePaths = imagePaths.filter(function (img) {
	    return img.indexOf('http') === -1;
	  });

	  var loaded_images = imagePaths ? Array.apply(null, Array(imagePaths.length)).map(Number.prototype.valueOf, 0) : [];
	  var data = {};

	  return new Promise(function (resolve, reject) {
	    if (imagePaths && imagePaths.length > 0) {
	      imagePaths.forEach(function (imgPath, i) {
	        var xhr = new XMLHttpRequest();
	        xhr.responseType = 'blob';

	        if (imgPath.indexOf('http') === -1) {
	          path = 'https://' + window.location.hostname + imgPath;
	        } else {
	          loaded_images[i] = 1;
	          return;
	        }
	        ...
	        ChecklistTester.requestImage(xhr, path.replace('&amp;', '&'));
	      });
	    } else {
	      resolve([]);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Litmus = __webpack_require__(6);
	const Utils = __webpack_require__(9);
	const BrowserFunctions = __webpack_require__(10);
	const Accounts = __webpack_require__(11);
	const ScriptInjector = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _servicesApi_service = __webpack_require__(7);

	var _commonEnvironmentWrapper = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonBrowserApi = __webpack_require__(13);

	var _commonBrowserApi2 = babelHelpers.interopRequireDefault(_commonBrowserApi);

	const jQuery = __webpack_require__(3);

	const ChecklistPresenter = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const ChecklistDragHandler = __webpack_require__(15);
...
/***/ }
/******/ ]);
//# sourceMappingURL=ibm-iframe.js.map